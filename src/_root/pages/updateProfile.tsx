...
const UpdateProfile = () => {
   ...
   const handleUpdate = async (value: z.infer<typeof ProfileValidation>) => {
      ...
      if (!updatedUser) {
         toast({
            title: `Ocorreu um erro ao actualizar o perfil, por-favor tente de novo`,
         });
      }
      setUser({
         ...user,
            ...
            <Form {...form}>
               <form
                  ...
                  <FormField
                     ...
                     render={({ field }) => (
                        <FormItem>
                           <FormLabel className="shad-form_label">Nome de útilizadore</FormLabel>
                           <FormControl>
                              <Input
                                 type="text"
